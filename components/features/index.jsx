        ...
        <div className="row">
          <div className="my-3 col-12 col-sm-6 col-md-4 col-lg-3">
            <div className={styles.feature_item}>
              <div
                className={`${styles.feature_item_icon} ${styles.feature_1}`}
              >
                <IoWallet />
              </div>
              <div className={styles.feature_item_info}>
                <Link href="/wallet-connect">
                  <a className={styles.feature_item_link}>some text here</a>
                </Link>
          ...
          <div className="my-3 col-12 col-sm-6 col-md-4 col-lg-3">
            <div className={styles.feature_item}>
              <div
                className={`${styles.feature_item_icon} ${styles.feature_2}`}
              >
                <HiViewGridAdd />
              </div>
              <div className={styles.feature_item_info}>
          ...
          <div className="my-3 col-12 col-sm-6 col-md-4 col-lg-3">
            <div className={styles.feature_item}>
              <div
                className={`${styles.feature_item_icon} ${styles.feature_3}`}
              >
                <IoMdPhotos />
              </div>
              <div className={styles.feature_item_info}>
          ...
          <div className="my-3 col-12 col-sm-6 col-md-4 col-lg-3">
            <div className={styles.feature_item}>
              <div
                className={`${styles.feature_item_icon} ${styles.feature_4}`}
              >
